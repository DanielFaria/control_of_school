...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { email: @aluno.email, nascimento: @aluno.nascimento, nome: @aluno.nome, string: @aluno.string }
    end
  ...
  test "should update aluno" do
    put :update, id: @aluno, aluno: { email: @aluno.email, nascimento: @aluno.nascimento, nome: @aluno.nome, string: @aluno.string }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
