...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { email: @professor.email, nascimento: @professor.nascimento, nome: @professor.nome, string: @professor.string }
    end
  ...
  test "should update professor" do
    put :update, id: @professor, professor: { email: @professor.email, nascimento: @professor.nascimento, nome: @professor.nome, string: @professor.string }
    assert_redirected_to professor_path(assigns(:professor))
  end
